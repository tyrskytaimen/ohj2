...
{
public:
    // Constructor initializes the game board with water drops at random locations
    GameBoard();

    // Prints the game board to the given stream by animating the flow of splashes
    void print(std::ostream& stream);

    // Checks if the game board is empty of drops, which means that the game is over
    bool isEmpty() const;
